      ...
      <div class="mainContent">
        ...
        <div class="profile-header-large">
          ...
          <div class="profile-details-large">
            ...
            <span>Trainer since <?php echo date('Y', strtotime($trainer['created_at'])); ?></span>
        ...
        <div class="form-section clearfix">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?php echo htmlspecialchars($trainer_name); ?>" />
          </div>
          <div class="form-group">
...
Certified yoga instructor with 5 years of experience specializing in Hatha and Vinyasa flows.</textarea
            >
          </div>
          <button
            class="action-btn"
