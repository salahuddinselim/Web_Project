...
<?php include __DIR__ . '/../includes/trainer_sidebar.php'; ?>
          ...
          <div class="contact-list">
            ...
            <div class="contact-item">
              <div class="contact-avatar">
                <div class="online-status"></div>
                <img
                  src="../images/pexels-koolshooters-6246587.jpg"
                  alt="Elma"
                />
              </div>
              <div class="contact-info">
        ...
        <div class="conversation-pane">
          ...
          <div class="messages-area" id="messagesArea">
            ...
            <div class="message-row received">
              ...
              <div>
                <div class="message-meta">Afia</div>
            ...
            <div class="message-row sent">
              <div>
                ...
                <div class="message-bubble">
                  Hello Afia, we have several options! Our 'Mindful Flow' class
            ...
            <div class="message-row received">
              ...
              <div>
                <div class="message-meta">Afia</div>
                <div class="message-bubble">
                  That sounds wonderful! Could you tell me more about the
                  'Mindful Flow' class? What days and times is it offered?
                </div>
              </div>
            </div>
            ...
            <div class="message-row sent">
              <div>
                <div class="message-meta">You</div>
                <div class="message-bubble">Certainly!</div>
              </div>
              <div style="margin-left: 10px">
                <img
                  src="../images/pregnant-woman-holding-fitness-mat.jpg"
            ...
            <div class="message-row sent">
              <div>
                <div class="message-meta">You</div>
                <div class="message-bubble">Yes.</div>
              </div>
              <div style="margin-left: 10px">
                <img
                  src="../images/pregnant-woman-holding-fitness-mat.jpg"
    ...
    <script>
      function sendMessage() {
        ...
        if (messageText) {
          // Construct the HTML for a new sent message
          const newMsgHTML = `
                    <div class="message-row sent">
                        <div>
                             <div class="message-meta">You</div>
                         ...
                         <div style="margin-left: 10px;">
                            <img src="../images/pregnant-woman-holding-fitness-mat.jpg" style="border-radius: 50%; width: 30px; height: 30px;">
                        </div>
                    </div>
                `;
