...
<body>
  <div class="mainContainer">
    ...
    <div class="mainContent">
      ...
      <div style="background-color: #0f1210; border: 1px solid #1f2b23; border-radius: 8px; padding: 40px; text-align: center; margin-top: 20px;">
        <h3 style="margin: 0 0 10px 0; color: #d1d5db;">No Content Available</h3>
        <p style="color: #a1a1aa; margin: 0 0 20px 0;">Content management feature is coming soon. This module will allow you to create and manage training materials for your members.</p>
        <button class="action-btn" style="background-color: #1a2e20; border: 1px solid #2a4030; color: #ffffff; padding: 10px 20px; border-radius: 6px; cursor: pointer;">
          Create Content
        </button>
      </div>
      ...
      <table class="content-table" style="display: none;">
        ...
        <td>
          <a
            class="action-link"
            onclick="alert('Edit Content: Pilates for Core Strength')">Edit</a>
        </td>
        </tr>
        </tbody>
      </table>
