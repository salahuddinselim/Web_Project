...
<?php include __DIR__ . '/../includes/member_sidebar.php'; ?>
    ...
    <div class="main-content">
      ...
      <div class="left-panel">
        ...
        <div class="day-selector" id="daySelector">
          <!-- Day buttons will be generated by JS -->
        </div>

        <!-- Day Details -->
        <div class="day-details" id="dayDetails">
          <div class="day-details-header">
            <span class="day-title" id="dayTitle">Day 1 - Foundation</span>
            <span class="day-status completed" id="dayStatus">Completed</span>
          </div>

          <div class="routine-list" id="routineList">
            <!-- Routine items will be generated by JS -->
          </div>
          ...
          <div class="post-workout" style="margin-top: 12px">
            <h2 style="margin-top: 10px; font-size: 14px; color: #aaa">
            ...
            <div
              ...
              "
            >
              <label style="font-size: 12px; color: #ccc">Rating (1-5)</label>
              <input
              ...
              <hr
                style="border: 0; border-top: 1px solid #222; margin: 8px 0"
              />

              <h3 style="font-size: 13px; color: #aaa; margin-top: 6px">
                Improvement Measurements (before / after)
              </h3>

              <label style="font-size: 12px; color: #ccc"
                >Flexibility (reach in cm)</label
              >
              ...
              <label style="font-size: 12px; color: #ccc">Mood (1-5)</label>
              <input
                id="moodLevel"
                type="number"
                min="1"
      ...
      <div class="right-panel">
        ...
        <div class="quick-actions">
          ...
          <button
            ...
            onclick="window.location.href='member_diet.html'"
          >
            <span>🥗</span> View Today's Diet
          </button>
          <button
            class="quick-action-btn"
            onclick="window.location.href='member_progress.html'"
          >
            <span>📊</span> Track Progress
          </button>
          <button
            class="quick-action-btn"
            onclick="window.location.href='member_chat.html'"
          >
            <span>💬</span> Ask Trainer
          </button>
        </div>
      </div>
    </div>
    ...
    <script>
      ...
      function toggleRoutine(index) {
        routineData[selectedDay].routines[index].done =
          !routineData[selectedDay].routines[index].done;
